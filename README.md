# Blinkered dictionary: Persian

The Persian word list, and the evidence for every word in it.

Built by [`blinkered-attestation`](https://github.com/blinkered/blinkered-attestation). The rule,
the evidence format and the reasoning live there; what lives here is Persian.

**41,801 of 51,132 candidates proved — 81.8%**, across 6 independent
families, 4 of which a stranger could check by fetching.

## What is in this repository

```
sources.mjs        which collections attest Persian, and why those
...
Candidates come from Blinkered's Persian list, which lives in
[`blinkered-attestation/candidates/fa`](https://github.com/blinkered/blinkered-attestation/tree/main/candidates/fa).
...
| **The words we could not prove** | `Apache-2.0` | `dropped.tsv` — **not ours to license** |
...
file a subset of that dictionary and it carries that dictionary's terms — here `Apache-2.0`.
